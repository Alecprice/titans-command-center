...
test('account layer is explicitly loaded and packaged offline',()=>{
  ...
  assert.match(html,/account-sync-v112\.js\?v=2/);assert.match(html,/account-v112\.js\?v=3/);assert.match(ui,/account-v112\.css\?v=4/);assert.match(sw,/account-sync-v112\.js/);assert.match(sw,/account-v112\.js/);assert.match(sw,/account-v112\.css/);assert.match(sw,/titans-cc-brand-2026-v59/);assert.match(quality,/scripts\/account-browser-smoke\.py/);
});
