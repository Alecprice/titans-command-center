...
test('TENX Legacy heritage cards and filters stay readable after injected heritage styles',()=>{
  ...
  assert.match(css,/\.legacy-page \.legacy-heritage-sources a\{[^}]*min-height:44px;font-size:12px!important/);
