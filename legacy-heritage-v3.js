...
function injectStyles(){
  ...
  style.textContent=`
    ...
    .legacy-heritage-intro p{margin:7px 0 0;color:#52697d;font-size:11px;line-height:1.55}
    ...
    .legacy-venue-index{display:flex;justify-content:space-between;gap:8px;color:#73889b;font-size:8px;font-weight:950;letter-spacing:.1em;text-transform:uppercase}
    ...
    .legacy-venue-city{color:var(--retro-red,#c8102e);font-size:8px;font-weight:950;text-transform:uppercase;letter-spacing:.1em}
    ...
    .legacy-venue-years strong{color:var(--retro-navy,#002144);font-size:11px}.legacy-venue-years span{color:#60788d;font-size:9px}
    .legacy-venue-card p{margin:0;color:#5c7184;font-size:10px;line-height:1.5}
    .legacy-heritage-sources{display:flex;gap:8px;flex-wrap:wrap;margin-top:10px}
    .legacy-heritage-sources a{display:inline-flex;align-items:center;min-height:44px;padding:0 10px;border:1px solid rgba(0,33,68,.14);background:#f7fafc;color:#4f6c83;font-size:8px;font-weight:850;line-height:1.25;text-decoration:none}
    ...
    .legacy-honors-head small{color:var(--retro-red,#c8102e);font-size:8px;font-weight:950;letter-spacing:.13em;text-transform:uppercase}
    ...
    .legacy-honor-card h4{margin:0;color:var(--retro-navy,#002144);font-size:12px;line-height:1.15}.legacy-honor-card p{margin:4px 0;color:#5f7488;font-size:9px;line-height:1.35}
    .legacy-honor-card small{display:block;color:#7a8c9b;font-size:8px}.legacy-honor-card strong{display:block;margin-top:5px;color:var(--retro-red,#c8102e);font-size:8px;text-transform:uppercase}
    ...
    @media(max-width:760px){.legacy-heritage-intro{grid-template-columns:1fr;padding:14px}.legacy-heritage-now{grid-template-columns:1fr 1fr}.legacy-heritage-now small{font-size:9px}.legacy-venue-scroll-cue{font-size:9px}.legacy-venue-grid{grid-template-columns:repeat(7,82vw)}.legacy-venue-card{min-height:220px}.legacy-venue-index,.legacy-venue-city{font-size:9px}.legacy-honors-head{display:block}.legacy-honors-head small{font-size:9px}.legacy-honors-head p{margin-top:8px}.legacy-heritage-sources a{min-height:48px!important;font-size:9px}.legacy-honor-filters{overflow-x:auto;flex-wrap:nowrap;padding-bottom:5px;scrollbar-width:none}.legacy-honor-filters::-webkit-scrollbar{display:none}.legacy-honor-filters button{min-height:48px;flex:0 0 auto;font-size:9px}.legacy-honor-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.legacy-honor-card p{font-size:10px}.legacy-honor-card small,.legacy-honor-card strong{font-size:9px}}
