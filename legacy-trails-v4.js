...
function injectStyles(){
  ...
  style.id=STYLE_ID;
  style.textContent=`
    .legacy-trails{min-width:0;width:100%;max-width:100%;box-sizing:border-box;margin:18px 0 24px;padding:18px;border:1px solid rgba(0,33,68,.15);background:linear-gradient(135deg,#f7f3ea 0 44%,#edf7fd 44% 100%);box-shadow:0 16px 42px rgba(0,33,68,.08)}
