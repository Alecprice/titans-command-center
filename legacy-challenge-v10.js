...
function ensureStyle(){
  ...
  style.textContent=`
    ...
    @media(max-width:760px){.legacy-challenge-head{grid-template-columns:1fr}.legacy-challenge-head small{font-size:12px;line-height:1.35}.legacy-challenge-head p{font-size:14px;line-height:1.6}.legacy-challenge-meta{font-size:12px;line-height:1.35}.legacy-challenge-mode strong{font-size:12px;line-height:1.25}.legacy-challenge-mode span{font-size:12px;line-height:1.4}.legacy-challenge-reference{font-size:13px;line-height:1.5}.legacy-challenge-feedback{font-size:13px;line-height:1.5}.legacy-challenge-options{grid-template-columns:1fr}.legacy-challenge-options button,.legacy-challenge-action,.legacy-challenge-start{min-height:48px;font-size:12px;line-height:1.25}.legacy-challenge-mode{min-height:48px}.legacy-challenge-actions{display:grid;grid-template-columns:1fr}.legacy-challenge[data-legacy-challenge-state="idle"]{padding:16px}.legacy-challenge[data-legacy-challenge-state="idle"] .legacy-challenge-head{grid-template-columns:1fr;gap:8px}.legacy-challenge[data-legacy-challenge-state="idle"] .legacy-challenge-head p{font-size:13px;line-height:1.5}.legacy-challenge[data-legacy-challenge-state="idle"] .legacy-challenge-stage{grid-template-columns:1fr;padding:12px}.legacy-challenge[data-legacy-challenge-state="idle"] .legacy-challenge-actions{display:block}.legacy-challenge[data-legacy-challenge-state="idle"] .legacy-challenge-start{width:100%;min-width:0}}
