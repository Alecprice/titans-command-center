...
export const sources = [
  ...
  {name:'NFL',category:'Official league',tier:'official',status:'Ready',method:'NFL.com public pages',cost:'Free',cadence:'Game / schedule updates',purpose:'Official cross-check for schedule, game status and league information'},
  ...
  {name:'ESPN',category:'Live sports',tier:'media',status:'Scoreboard fallback only',method:'Unofficial JSON endpoints',cost:'Free / undocumented',cadence:'Near live',purpose:'Replaceable near-live scoreboard/basic fallback; not authoritative roster or injury data'},
  ...
  {name:'Pro Football Hall of Fame / PFR',category:'Historical reference',tier:'media',status:'Cross-check',method:'Public reference pages',cost:'Free',cadence:'Seasonal',purpose:'Franchise milestones, records and historical/statistical cross-checks'},
