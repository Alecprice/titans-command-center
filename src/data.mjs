...
export const sources = [
  ...
  {name:'ESPN',category:'Live sports',tier:'media',status:'Scoreboard fallback · final-score reconciliation',method:'Unofficial JSON endpoints',cost:'Free / undocumented',cadence:'Near live',purpose:'Secondary near-live scoreboard and bounded final-score backfill; not authoritative roster or injury data; Tennessee Titans official sources remain the audit authority'},
