...
import providerHealth from './api/provider-health.js';
import data from './api/data.js';
import player from './api/player.js';
import analytics from './api/analytics.js';
import odds from './api/odds.js';
import blueskySearch from './api/bluesky-search.js';
...
const apiHandlers=new Map([
  ['/api/health',health],['/api/provider-health',providerHealth],['/api/data',data],['/api/player',player],
  ['/api/analytics',analytics],['/api/odds',odds],['/api/bluesky-search',blueskySearch],
  ['/api/espn-scoreboard',espnScoreboard],['/api/sync',sync],['/api/cron-refresh',cronRefresh]
]);
function localRequest(req,url){return {method:req.method,headers:req.headers,query:Object.fromEntries(url.searchParams.entries())}}
