...
- Source commit: `3173f3e7a8de50fee65b5762fb0a94de471b7db9`
- Quality gate: success
- Cloudflare credentials available: true
- Source still current main: true
- Main SHA observed before deploy: `3173f3e7a8de50fee65b5762fb0a94de471b7db9`
...
```json
{
  ...
  "deployedCommit": "3173f3e7a8de50fee65b5762fb0a94de471b7db9",
  "version": "1.0.0",
  "revisionAttempts": 1,
  ...
  "cloudFront": {
    "requestId": "vyrZnGfWtCwg7TRMTkqw2w9Q-sIb0356tvSevoYx8Mecv5o1k3ROdQ==",
    "pop": "ORD51-P2",
    "via": "1.1 abe1f16540d67a1618a17aca8742e52e.cloudfront.net (CloudFront)",
  ...
  "testedAt": "2026-09-03T15:44:01.582Z"
}```
...
```json
{
  ...
  "buildMeta": {
    ...
    "version": "1.0.0",
    "commit": "3173f3e7a8de50fee65b5762fb0a94de471b7db9",
    "builtAt": "2026-09-03T15:43:20.245Z"
  },
  ...
  "testedAt": "2026-09-03T15:44:18.955Z",
  "healthTruth": {
    "ok": true,
    "mode": "d1-snapshot",
    "status": 200,
    ...
    "edgeCacheStatus": "HIT",
    "responseMs": 175,
    "testedAt": "2026-09-03T15:44:19.320Z"
  },
  "marketEdgeCache": {
    "ok": true,
    "base": "https://titans.alecjprice.com",
    ...
    "testedAt": "2026-09-03T15:44:19.432Z"
  },
  "analyticsStatus": 200,
...
```json
{
  ...
  "fetchedAt": "2026-09-03T15:44:19.962Z",
  "testedAt": "2026-09-03T15:44:20.326Z"
}```
...
```json
{
  ...
  "durationMs": 132,
  "testedAt": "2026-09-03T15:44:19.856Z"
}```
...
```json
{
  ...
  "youtube": {
    ...
    "iframeAfterPlay": {
      ...
      "iframeSrc": "https://www.youtube.com/embed/NIJRkJ6ci5Q?autoplay=0&playsinline=1&rel=0&origin=https%3A%2F%2Ftitans.alecjprice.com&enablejsapi=1&widgetid=1&forigin=https%3A%2F%2Ftitans.alecjprice.com%2F%23media&aoriginsup=1&vf=1",
      "videoId": "NIJRkJ6ci5Q"
    }
  },
  "mobileAreaTargets": [
  ...
  "browserWarnings": [
    {
      ...
      "source": "other",
      "timestamp": 1788450285762
    }
  ],
  "durationSeconds": 2.76,
  "testedAt": "2026-09-03T15:44:46Z"
}```
...
```json
{
  ...
  "desktop": {
    ...
    "refresh": {
      "cache": [
        {
          "expiresAt": 1788450343232,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788450313232,
          "url": "/api/data"
        },
        {
          "expiresAt": 1788450343278,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788450313278,
          "url": "/api/fan-intel"
        }
      ],
      "epoch": 1,
      "last": {
        "at": "2026-09-03T15:45:13.199Z",
        "epoch": 1,
