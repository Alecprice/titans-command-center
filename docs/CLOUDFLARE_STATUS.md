...
- Source commit: `2f3c08fc256fbc47a12addc905ccb53614f77ab8`
- Quality gate: success
- Cloudflare credentials available: true
- Source still current main: true
- Main SHA observed before deploy: `2f3c08fc256fbc47a12addc905ccb53614f77ab8`
...
```json
{
  ...
  "expectedCommit": "2f3c08fc256fbc47a12addc905ccb53614f77ab8",
  "deployedCommit": "2f3c08fc256fbc47a12addc905ccb53614f77ab8",
  "rollbackCommit": "2f3c08fc256fbc47a12addc905ccb53614f77ab8",
  ...
  "cloudFront": {
    "requestId": "TETziLsE14yArkeRLNx497rpxqjnAr5_Js_TcM84AnM6ZniBIflz1Q==",
    "pop": "IAD55-P2",
  ...
  "testedAt": "2026-09-06T12:15:27.863Z"
}```
...
```json
{
  ...
  "buildMeta": {
    ...
    "version": "1.0.0",
    "commit": "2f3c08fc256fbc47a12addc905ccb53614f77ab8",
    "builtAt": "2026-09-06T12:15:09.879Z"
  },
  ...
  "testedAt": "2026-09-06T12:15:33.879Z",
  "healthTruth": {
    "ok": true,
    "mode": "d1-snapshot",
    "status": 200,
    ...
    "edgeCacheStatus": "HIT",
    "responseMs": 252,
    "testedAt": "2026-09-06T12:15:34.361Z"
  },
  "marketEdgeCache": {
    "ok": true,
    "base": "https://titans.alecjprice.com",
    ...
    "testedAt": "2026-09-06T12:15:34.534Z"
  },
  "analyticsStatus": 200,
...
```json
{
  ...
  "fetchedAt": "2026-09-06T12:15:35.241Z",
  "testedAt": "2026-09-06T12:15:35.519Z"
}```
...
```json
{
  ...
  "durationMs": 114,
  "testedAt": "2026-09-06T12:15:35.073Z"
}```
  ...
  "browserWarnings": [
    {
      ...
      "source": "other",
      "timestamp": 1788696958951
    }
  ],
  "durationSeconds": 3.15,
  "testedAt": "2026-09-06T12:15:59Z"
}```
...
```json
{
  ...
  "desktop": {
    ...
    "refresh": {
      "cache": [
        {
          "expiresAt": 1788697012520,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788696982520,
          "url": "/api/data"
        },
        {
          "expiresAt": 1788697012593,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788696982593,
          "url": "/api/fan-intel"
        }
      ],
      "epoch": 1,
      "last": {
        "at": "2026-09-06T12:16:22.491Z",
        "epoch": 1,
...
```json
{
  ...
  "testedAt": "2026-09-06T12:16:31Z",
  "deterministicMobile": {
    "ok": false,
    "base": "https://titans.alecjprice.com",
    "stage": "mobile-viewport",
    "error": "RuntimeError: Analytics mobile viewport override did not take effect: {'clientWidth': 980, 'innerHeight': 2121, 'innerWidth': 980, 'mobile': False}",
    "browserWarnings": [],
    "toleratedRoster424": [],
    "allSevere": [],
    "durationSeconds": 0.5,
    "testedAt": "2026-09-06T12:16:32Z"
  }
}```
