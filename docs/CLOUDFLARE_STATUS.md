...
- Source commit: `4e3b132c5a62b5ae5f0081207b2e03b52bbeca85`
...
```json
{
  ...
  "revisionAttempts": 1,
  "cloudFront": {
    "requestId": "2DEGy6WHdXhzQu-GhmtwHGROZLeoTacxJMJD7itKIJCESpjKW07Ifw==",
    "pop": "IAD55-P2",
  ...
  "testedAt": "2026-09-01T19:49:02.474Z"
}```
...
```json
{
  ...
  "buildMeta": {
    ...
    "version": "1.0.0",
    "commit": "4e3b132c5a62b5ae5f0081207b2e03b52bbeca85",
    "builtAt": "2026-09-01T19:48:46.567Z"
  },
  ...
  "testedAt": "2026-09-01T19:49:41.467Z",
  "healthTruth": {
    "ok": true,
    ...
    "edgeCacheStatus": "HIT",
    "responseMs": 590,
    "testedAt": "2026-09-01T19:49:42.604Z"
  },
  "marketEdgeCache": {
    "ok": true,
    "base": "https://titans.alecjprice.com",
    ...
    "testedAt": "2026-09-01T19:49:42.956Z"
  },
  "analyticsStatus": 200,
...
```json
{
  ...
  "durationMs": 413,
  "testedAt": "2026-09-01T19:49:43.915Z"
}```
  ...
  "browserWarnings": [
    {
      ...
      "source": "other",
      "timestamp": 1788292203280
    }
  ],
  "durationSeconds": 5.47,
  "testedAt": "2026-09-01T19:50:03Z"
}```
...
```json
{
  ...
  "browserWarnings": [],
  "durationSeconds": 13.19,
  "testedAt": "2026-09-01T19:50:17Z"
}```
...
```json
{
  ...
  "desktop": {
    ...
    "refresh": {
      "cache": [
        {
          "expiresAt": 1788292273338,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788292243338,
          "url": "/api/data"
        },
        {
          "expiresAt": 1788292273422,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788292243422,
          "url": "/api/fan-intel"
        },
        {
          "expiresAt": 1788292543302,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788292243302,
          "url": "/api/tickets"
        }
      ],
      "epoch": 1,
      "last": {
        "at": "2026-09-01T19:50:43.247Z",
        "epoch": 1,
