...
- Source commit: `30beec96e34b116d757ff0e8a25096b5adbf7db5`
- Quality gate: success
- Cloudflare credentials available: true
- Source still current main: true
- Main SHA observed before deploy: `30beec96e34b116d757ff0e8a25096b5adbf7db5`
...
```json
{
  ...
  "expectedCommit": "30beec96e34b116d757ff0e8a25096b5adbf7db5",
  "deployedCommit": "30beec96e34b116d757ff0e8a25096b5adbf7db5",
  "rollbackCommit": "30beec96e34b116d757ff0e8a25096b5adbf7db5",
  ...
  "cloudFront": {
    "requestId": "kQkpNrO0eCwxXHh0GNN2tKQ0MaXqzq2oZqGFLvx__AgI5rBZvdv0eQ==",
    "pop": "SFO5-P1",
    "via": "1.1 eac5ff8c8951bc7fa5bbf706c830ab88.cloudfront.net (CloudFront)",
  ...
  "testedAt": "2026-09-06T19:39:55.950Z"
}```
...
```json
{
  ...
  "buildMeta": {
    ...
    "version": "1.0.0",
    "commit": "30beec96e34b116d757ff0e8a25096b5adbf7db5",
    "builtAt": "2026-09-06T19:39:41.120Z"
  },
  ...
  "testedAt": "2026-09-06T19:40:02.062Z",
  "healthTruth": {
    "ok": true,
    "mode": "d1-snapshot",
    "status": 200,
    ...
    "edgeCacheStatus": "HIT",
    "responseMs": 191,
    "testedAt": "2026-09-06T19:40:02.476Z"
  },
  "marketEdgeCache": {
    "ok": true,
    "base": "https://titans.alecjprice.com",
    ...
    "testedAt": "2026-09-06T19:40:02.609Z"
  },
  "analyticsStatus": 200,
...
```json
{
  ...
  "fetchedAt": "2026-09-06T19:40:03.177Z",
  "testedAt": "2026-09-06T19:40:03.573Z"
}```
...
```json
{
  ...
  "base": "https://titans.alecjprice.com",
  "season": 2026,
  "generatedAt": "2026-09-06T14:24:57.912451+00:00",
  "rosterRows": 93,
  "headshotCount": 91,
  "coveragePct": 97.8,
  "omittedCount": 2,
  ...
  "durationMs": 101,
  "testedAt": "2026-09-06T19:40:03.037Z"
}```
...
```json
{
  ...
  "browserWarnings": [],
  "durationSeconds": 20.18,
  "testedAt": "2026-09-06T19:40:27Z"
}```
...
```json
{
  ...
  "youtube": {
    ...
    "iframeAfterPlay": {
      ...
      "iframeSrc": "https://www.youtube.com/embed/3WEgDDx_nL0?autoplay=0&playsinline=1&rel=0&origin=https%3A%2F%2Ftitans.alecjprice.com&enablejsapi=1&widgetid=1&forigin=https%3A%2F%2Ftitans.alecjprice.com%2F%23media&aoriginsup=1&vf=1",
      "videoId": "3WEgDDx_nL0"
    }
  },
  "mobileAreaTargets": [
  ...
  "browserWarnings": [
    {
      ...
      "source": "other",
      "timestamp": 1788723630943
    }
  ],
  "durationSeconds": 3.44,
  "testedAt": "2026-09-06T19:40:31Z"
}```
  ...
  "desktop": {
    "initial": {
      ...
      "summary": {
        ...
        "referenceNotice": "",
        "refreshHeight": 44,
        "result": "Matching 46 of 608 rows",
        "resultTotal": 608,
        "rowCount": 46,
        "rowSample": [
    ...
    "filters": {
      "event": {
        ...
        "options": 3,
        "selectedValue": "25077",
        "before": "Matching 46 of 608 rows",
        "after": "Matching 38 of 608 rows"
      },
      "book": {
        "available": true,
        "options": 8,
...
```json
{
  ...
  "desktop": {
    ...
    "refresh": {
      "cache": [
        {
          "expiresAt": 1788723684793,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788723654793,
          "url": "/api/data"
        },
        {
          "expiresAt": 1788723684909,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788723654909,
          "url": "/api/fan-intel"
        }
      ],
      "epoch": 1,
      "last": {
        "at": "2026-09-06T19:40:54.754Z",
        "epoch": 1,
...
```json
{
  ...
  "base": "https://titans.alecjprice.com",
  "desktop": {
    "detail": "Roster verified Sep 2 \u00b7 Moves 4 days ago \u00b7 Intel 4 days ago",
    "overflow": false,
    "rect": {
      "bottom": 1729.5,
      "height": 139.578125,
    ...
    "text": "DATA FRESHNESSVerified backup \u00b7 Sep 2Roster verified Sep 2 \u00b7 Moves 4 days ago \u00b7 Intel 4 days agoSee sources \u2192",
