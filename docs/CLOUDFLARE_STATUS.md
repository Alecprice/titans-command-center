...
- Source commit: `1b9a3b881e7c8df81c71f439f77fb522f64ba189`
...
```json
{
  ...
  "buildMeta": {
    ...
    "version": "1.0.0",
    "commit": "1b9a3b881e7c8df81c71f439f77fb522f64ba189",
    "builtAt": "2026-08-30T20:29:43.763Z"
  },
  ...
  "testedAt": "2026-08-30T20:30:53.409Z",
  "healthTruth": {
    "ok": true,
    ...
    "databaseAvailable": false,
    "responseMs": 460,
    "testedAt": "2026-08-30T20:30:53.908Z"
  },
  "marketEdgeCache": {
    "ok": true,
    "base": "https://titans-command-center.alecjordanprice.workers.dev",
    ...
    "testedAt": "2026-08-30T20:30:54.292Z"
  },
  "analyticsStatus": 200,
...
```json
{
  ...
  "durationMs": 183,
  "testedAt": "2026-08-30T20:30:54.941Z"
}```
...
```json
{
  ...
  "youtube": {
    ...
    "iframeAfterPlay": {
      ...
      "iframeSrc": "https://www.youtube.com/embed/-5pWxi4ylt8?autoplay=0&playsinline=1&rel=0&origin=https%3A%2F%2Ftitans-command-center.alecjordanprice.workers.dev&enablejsapi=1&widgetid=1&forigin=https%3A%2F%2Ftitans-command-center.alecjordanprice.workers.dev%2F%23media&aoriginsup=1&vf=1",
      "videoId": "-5pWxi4ylt8"
    }
  },
  "mobileAreaTargets": [
  ...
  "browserWarnings": [
    {
      ...
      "source": "other",
      "timestamp": 1788121879660
    }
  ],
  "durationSeconds": 3.16,
  "testedAt": "2026-08-30T20:31:20Z"
}```
...
```json
{
  ...
  "browserWarnings": [],
  "durationSeconds": 6.47,
  "testedAt": "2026-08-30T20:31:26Z"
}```
...
```json
{
  ...
  "browserWarnings": [],
  "durationSeconds": 4.47,
  "testedAt": "2026-08-30T20:31:34Z"
}```
...
```json
{
  ...
  "desktop": {
    ...
    "refresh": {
      "cache": [
        {
          "expiresAt": 1788121930482,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788121900482,
          "url": "/api/data"
        },
        {
          "expiresAt": 1788121930539,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788121900539,
          "url": "/api/fan-intel"
        }
      ],
      "epoch": 1,
      "last": {
        "at": "2026-08-30T20:31:40.444Z",
        "epoch": 1,
