...
- Source commit: `6895cbd412bf4d0e42ac04cabb55c7f4521e7eae`
...
```json
{
  ...
  "deployedCommit": "d8f444767965b372cc21d3d669ee39fac0dad0dd",
  "version": "1.0.0",
  "revisionAttempts": 1,
  "cloudFront": {
    "requestId": "I60vupEdDmnqBhwFhi0KMRhjs4UMg2GFs8LiiHQNtTvsupA5vw9r-w==",
    "pop": "DFW57-P1",
    "via": "1.1 22067fb5d7eb764108747a104222f50a.cloudfront.net (CloudFront)",
  ...
  "testedAt": "2026-09-01T12:19:09.768Z"
}```
...
```json
{
  ...
  "buildMeta": {
    ...
    "version": "1.0.0",
    "commit": "6895cbd412bf4d0e42ac04cabb55c7f4521e7eae",
    "builtAt": "2026-09-01T12:18:52.221Z"
  },
  ...
  "testedAt": "2026-09-01T12:19:27.600Z",
  "healthTruth": {
    "ok": true,
    "mode": "d1-snapshot",
    "status": 200,
    ...
    "snapshotFresh": true,
    "responseMs": 354,
    "testedAt": "2026-09-01T12:19:27.984Z"
  },
  "marketEdgeCache": {
    "ok": true,
    "base": "https://titans.alecjprice.com",
    ...
    "testedAt": "2026-09-01T12:19:28.189Z"
  },
  "analyticsStatus": 200,
...
```json
{
  ...
  "durationMs": 222,
  "testedAt": "2026-09-01T12:19:28.756Z"
}```
...
```json
{
  ...
  "browserWarnings": [],
  "durationSeconds": 17.71,
  "testedAt": "2026-09-01T12:19:52Z"
}```
  ...
  "browserWarnings": [
    {
      ...
      "source": "other",
      "timestamp": 1788265196014
    }
  ],
  "durationSeconds": 3.67,
  "testedAt": "2026-09-01T12:19:56Z"
}```
...
```json
{
  ...
  "desktop": {
    ...
    "refresh": {
      "cache": [
        {
          "expiresAt": 1788265245591,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788265215591,
          "url": "/api/data"
        },
        {
          "expiresAt": 1788265245690,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788265215690,
          "url": "/api/fan-intel"
        }
      ],
      "epoch": 1,
      "last": {
        "at": "2026-09-01T12:20:15.542Z",
        "epoch": 1,
...
```json
{
  ...
  "base": "https://titans.alecjprice.com",
  "desktop": {
    "detail": "Roster verified Aug 31 \u00b7 Moves 16 hours ago \u00b7 Intel 16 hours ago",
    "overflow": false,
    "rect": {
      "bottom": 1296.1875,
      "height": 139.578125,
    ...
    "text": "DATA FRESHNESSVerified backup \u00b7 Aug 31Roster verified Aug 31 \u00b7 Moves 16 hours ago \u00b7 Intel 16 hours agoSee sources \u2192",
...
```json
{
  ...
  "state": {
    "appText": "PERSONNEL\nROSTER\n\nSearch the latest verified Titans roster by name, number, position, or unit.\n\nRoster \u00b7 freshness unknown\n2026 INJURY-REPORT STATUS\nOfficial weekly injury report not yet published\n\nThe Titans state that injury reports become available in the regular season. Reserve/Injured roster status is tracked separately and should not be prese",
    "firstSrc": "https://static.www.nfl.com/image/upload/f_auto,q_auto/league/bhgovss7uhkszgbrfxd6",
    "hash": "#roster",
    "onboarding": false,
    "rosterCards": 61,
    "rosterLoaded": 39,
  ...
  "durationSeconds": 13.38,
  "testedAt": "2026-09-01T12:20:37Z"
}```
