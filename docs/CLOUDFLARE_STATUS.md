...
- Source commit: `709ee687e0a1242a5dddb8ceadff36c23cdd8d1d`
- Quality gate: success
- Cloudflare credentials available: true
- Source still current main: true
- Main SHA observed before deploy: `709ee687e0a1242a5dddb8ceadff36c23cdd8d1d`
...
```json
{
  ...
  "expectedCommit": "709ee687e0a1242a5dddb8ceadff36c23cdd8d1d",
  "deployedCommit": "709ee687e0a1242a5dddb8ceadff36c23cdd8d1d",
  "rollbackCommit": "709ee687e0a1242a5dddb8ceadff36c23cdd8d1d",
  ...
  "cloudFront": {
    "requestId": "AKemlecQStUpACR2-YCATblA0AeDkp7IBevl84hKlESkiRFNV6i1MQ==",
    "pop": "DFW57-P1",
    "via": "1.1 a183b6545fea485604515ba7931cb9b8.cloudfront.net (CloudFront)",
  ...
  "testedAt": "2026-09-09T13:33:41.800Z"
}```
...
```json
{
  ...
  "buildMeta": {
    ...
    "version": "1.0.0",
    "commit": "709ee687e0a1242a5dddb8ceadff36c23cdd8d1d",
    "builtAt": "2026-09-09T13:33:20.187Z"
  },
  ...
  "testedAt": "2026-09-09T13:33:51.519Z",
  "healthTruth": {
    "ok": true,
    "mode": "d1-snapshot",
    "status": 200,
    ...
    "dataAudit": "2026-09-09",
    "databaseProvider": "cloudflare-d1",
    "snapshotFresh": true,
    "edgeCacheStatus": "HIT",
    "responseMs": 286,
    "testedAt": "2026-09-09T13:33:52.037Z"
  },
  "marketEdgeCache": {
    "ok": true,
    "base": "https://titans.alecjprice.com",
    ...
    "testedAt": "2026-09-09T13:33:54.991Z"
  },
  "analyticsStatus": 200,
...
```json
{
  ...
  "fetchedAt": "2026-09-09T13:33:55.615Z",
  "testedAt": "2026-09-09T13:33:55.988Z"
}```
...
```json
{
  ...
  "base": "https://titans.alecjprice.com",
  "season": 2026,
  "generatedAt": "2026-09-08T15:19:27.505689+00:00",
  "rosterRows": 93,
  "headshotCount": 91,
  "coveragePct": 97.8,
  "omittedCount": 2,
  ...
  "durationMs": 164,
  "testedAt": "2026-09-09T13:33:55.436Z"
}```
...
```json
{
  ...
  "youtube": {
    ...
    "iframeAfterPlay": {
      ...
      "iframeSrc": "https://www.youtube.com/embed/EX6rDmGXz-U?autoplay=0&playsinline=1&rel=0&origin=https%3A%2F%2Ftitans.alecjprice.com&enablejsapi=1&widgetid=1&forigin=https%3A%2F%2Ftitans.alecjprice.com%2F%23media&aoriginsup=1&vf=1",
      "videoId": "EX6rDmGXz-U"
    }
  },
  "mobileAreaTargets": [
  ...
  "browserWarnings": [
    {
      ...
      "source": "other",
      "timestamp": 1788960852221
    }
  ],
  "durationSeconds": 3.19,
  "testedAt": "2026-09-09T13:34:13Z"
}```
...
```json
{
  ...
  "desktop": {
    "initial": {
      ...
      "summary": {
        ...
        "referenceNotice": "",
        "refreshHeight": 44,
        "result": "Matching 66 of 630 rows",
        "resultTotal": 630,
        "rowCount": 66,
        "rowSample": [
          ...
          "New York Jets at Tennessee Titans Spread \u00b7 BetRivers \u2197SideNew York JetsLine1.5Price-110Implied52.4%"
        ],
        "scrollWidth": 1265,
        "shown": 66,
    ...
    "filters": {
      "event": {
        ...
        "options": 3,
        "selectedValue": "25077",
        "before": "Matching 66 of 630 rows",
        "after": "Matching 38 of 630 rows"
      },
      "book": {
        "available": true,
        "options": 11,
    ...
    "refresh": {
      ...
      "summary": {
        ...
        "referenceNotice": "",
        "refreshHeight": 44,
        "result": "Matching 630 of 630 rows",
        "resultTotal": 630,
        "rowCount": 72,
        "rowSample": [
          "New York Jets at Tennessee Titans Spread \u00b7 BetOnline.ag \u2197SideNew York JetsLine0Price-104Implied51.0%",
  ...
  "durationSeconds": 5.58,
  "testedAt": "2026-09-09T13:34:18Z"
}```
...
```json
{
  ...
  "desktop": {
    ...
    "refresh": {
      "cache": [
        {
          "expiresAt": 1788960904580,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788960874580,
          "url": "/api/data"
        },
        {
          "expiresAt": 1788960904651,
          "hasValue": true,
          "inflight": false,
          "updatedAt": 1788960874651,
          "url": "/api/fan-intel"
        }
      ],
      "epoch": 1,
      "last": {
        "at": "2026-09-09T13:34:34.518Z",
        "epoch": 1,
...
```json
{
  ...
  "base": "https://titans.alecjprice.com",
  "desktop": {
    "detail": "Roster verified Sep 2 \u00b7 Moves 7 days ago \u00b7 Intel 7 days ago",
    "overflow": false,
    "rect": {
      "bottom": 1729.5,
      "height": 139.578125,
    ...
    "text": "DATA FRESHNESSVerified backup \u00b7 Sep 2Roster verified Sep 2 \u00b7 Moves 7 days ago \u00b7 Intel 7 days agoSee sources \u2192",
