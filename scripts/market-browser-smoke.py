...
try:
    ...
    stage='market-load'
    driver.get(f'{BASE}/#markets');prepare_returning_user(driver)
    ...
    stage='alternates'
    alt_button=driver.find_elements(By.CSS_SELECTOR,'#mh-alt-toggle');alt_before=count(driver,'.mh-row');alt_after=alt_before;alt_enabled=False
    ...
    stage='mobile'
    driver.set_window_size(390,844);time.sleep(.25)
