(() => {
  ...
  let state=loadState(),data=null,renderSerial=0,connectSerial=0,leagueLoadSerial=0,sleeper={user:null,leagues:[],league:null,rosters:[],users:[],matchups:[],drafts:[],picks:[],error:'',draftError:'',connecting:false,loading:false,draftLoading:false};
